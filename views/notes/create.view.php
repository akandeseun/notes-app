          ...
          <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div class="col-span-full">
              ...
              <div class="mt-2">
                ...
                <!-- above i'm echoing out what the user typed in the text area incase of errors and mistakes using the null coalescing operator, i could have also made use of th ternary operator or if condition to acheive the same thing: so what it does is that it returns $_POST["body"] if its not null and an empty string "" if it is null -->
